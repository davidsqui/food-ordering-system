...
public class PaymentDomainServiceImpl implements PaymentDomainService {
  ...
  private void updateCreditEntry(Payment payment, List<CreditHistory> creditHistories,
  ...
  private void validateCreditHistory(CreditEntry creditEntry, List<CreditHistory> creditHistories,
    ...
    if (!creditEntry.getTotalCreditAmount()
      ...
      log.error("Credit entry total is not equal to current credit for customer id : {}",
          creditEntry.getCustomerId().getValue());
      failureMessages.add("Credit entry total is not equal to current credit for customer id : "
          + creditEntry.getCustomerId().getValue());
    }
  }
